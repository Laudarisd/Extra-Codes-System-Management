...
if __name__ == "__main__":
    ...
    #os.mkdir("./aug/images")
    #os.mkdir("./aug/xmls")
    desire_class = ["blue_bicycle",
                    "red_no_two_wheels",
                    "red_straight_not_allowed",
                    "warning_right_hand_bend_road",
                    "warning_right_hand_intersection",
                    "info",
                    "blue_both_side",
                    "blue_other",
                    "red_yield",
                    "warning_speed_breaker",
                    "warning_left_hand_curved",
                    "stop",
                    "warning_danger",
                    "red_no_pedestrian",
                    "red_no_entry",
                    "warning_missing_right_side",
                    "red_other",
                    "blue_circle_uturn",
                    "warning_bicycle",
                    "killopost",
                    "blue_straight_allowed"
                    ]
