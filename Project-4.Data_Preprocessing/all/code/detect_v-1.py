...
from utils.extract_gps import get_exif, get_geotagging, get_labeled_exif, get_decimal_from_dms, get_coordinates 
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if len(det):
                ...
                desire_param.append({"image_id":p.name,
                			"prediction": pr})
...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default='./test_1', help='file/dir/URL/glob')
